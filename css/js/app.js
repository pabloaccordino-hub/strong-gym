...
function showExerciseDetails(
    ...
    if (!modal) {
        ...
        style.textContent = `
            ...
            .exercise-detail-modal.active .exercise-detail-card {
    ...
    const technique =
        Array.isArray(exercise.technique)
            ? exercise.technique
            : [];

    const errors =
        Array.isArray(exercise.errors)
            ? exercise.errors
            : [];
        ...
        >
            ...
            <div class="exercise-detail-grid">
                ...
                <div class="exercise-detail-stat">
                    ...
                    <span class="exercise-detail-stat-value">
                        ${escapeExerciseHTML(
                            exercise.level || "No especificado"
                        )}
                    </span>
                </div>
    ...
    if (!modal) {
        ...
        continueButton.addEventListener(
            ...
            () => {
                ...
                alert(
                    `✅ Rutina "${routineName}" creada.\n\nDías: ${selectedDays.join(", ")}\n\nEl siguiente paso será agregar ejercicios.`
                );
